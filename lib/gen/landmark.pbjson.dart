...
@$core.Deprecated('Use landmarkListCollectionDescriptor instead')
const LandmarkListCollection$json = const {
  '1': 'LandmarkListCollection',
  '2': const [
    const {'1': 'landmark_list', '3': 1, '4': 3, '5': 11, '6': '.mediapipe.LandmarkList', '10': 'landmarkList'},
  ],
};

/// Descriptor for `LandmarkListCollection`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List landmarkListCollectionDescriptor = $convert.base64Decode('ChZMYW5kbWFya0xpc3RDb2xsZWN0aW9uEjwKDWxhbmRtYXJrX2xpc3QYASADKAsyFy5tZWRpYXBpcGUuTGFuZG1hcmtMaXN0UgxsYW5kbWFya0xpc3Q=');
...
@$core.Deprecated('Use normalizedLandmarkListCollectionDescriptor instead')
const NormalizedLandmarkListCollection$json = const {
  '1': 'NormalizedLandmarkListCollection',
  '2': const [
    const {'1': 'landmark_list', '3': 1, '4': 3, '5': 11, '6': '.mediapipe.NormalizedLandmarkList', '10': 'landmarkList'},
  ],
};

/// Descriptor for `NormalizedLandmarkListCollection`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List normalizedLandmarkListCollectionDescriptor = $convert.base64Decode('CiBOb3JtYWxpemVkTGFuZG1hcmtMaXN0Q29sbGVjdGlvbhJGCg1sYW5kbWFya19saXN0GAEgAygLMiEubWVkaWFwaXBlLk5vcm1hbGl6ZWRMYW5kbWFya0xpc3RSDGxhbmRtYXJrTGlzdA==');
